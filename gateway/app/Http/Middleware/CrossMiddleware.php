...
//            }
     ...
     * @return ResponseInterface
     */
    public function setResponseHeaders(ResponseInterface $response): ResponseInterface
    {
        return $response->withHeader('Access-Control-Allow-Origin', '*')
                        ->withHeader('Access-Control-Allow-Headers','Authorization, Access-Control-Request-Method, Content-Type, Accept, Origin')
